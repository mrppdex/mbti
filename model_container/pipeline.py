...
class Mtbi:
	def __init__(self, text, types):
		clear_session()
		try:
			with open("./data/tfid_vectorizer.pkl", "rb") as tf:
		...
		try:
			with open("./data/tsvd_red.pkl", "rb") as f:
		...
		try:
			with open("./data/posts_tokenizer.pkl", "rb") as f:
		...
		try:
			with open("./data/scaler.pkl", "rb") as sf:
